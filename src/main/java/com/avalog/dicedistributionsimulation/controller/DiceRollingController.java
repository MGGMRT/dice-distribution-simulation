...
public class DiceRollingController {
  ...
  public ResponseEntity<DiceSimulationDto> diceRolling(
      @RequestParam(
              name = "numberOfDiceRolls",
              required = true,
              defaultValue = DEFAULT_DICE_ROLL_NUMBER)
          @Min(MIN_DICE_ROLL_NUMBER)
          @Max(MAX_DICE_ROLL_NUMBER)
    ...
    DiceSimulationDto diceSimulationDto =
        diceRollingService.diceRolling(numberOfDiceRolls, numOfDice, numOfSide);
    return ResponseEntity.ok(diceSimulationDto);
  }
  ...
  public ResponseEntity<List<CombinationDto>> getlistOfCombinations() {
    List<CombinationDto> combinationDtoList = diceRollingService.getSimulationCombinationList();
  ...
  public ResponseEntity<List<ProbabilityDistributionDto>> getListOfProbability() {
    List<ProbabilityDistributionDto> probabilityDistributionDtoList =
        diceRollingService.getSimulationProbabilityList();
